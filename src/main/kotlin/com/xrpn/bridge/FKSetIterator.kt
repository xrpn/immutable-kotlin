...
class FKSetIterator<out K, out A: Any> internal constructor(val seed: FKSet<K, A>, val resettable: Boolean = true): Iterator<A>, Iterable<A> where K: Any, K: Comparable<@UnsafeVariance K> {
