...
class FKMapIterator<out K, out V: Any> internal constructor (val seed: FKMap<K, V>, val resettable: Boolean = true): Iterator<TKVEntry<K, V>>, Sequence<TKVEntry<K, V>> where K: Any, K: Comparable<@UnsafeVariance K> {
