...
interface IMListTransforming<out A: Any> {
    ...
    fun <B> ffoldSimple(maintainOrder: Boolean, z: B, f: (A, acc: B) -> B): B // 	“Fold” the elements of the list using the binary operator o, using an initial seed s, going from right to left (see also reduceRight)
