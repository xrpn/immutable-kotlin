...
interface IMBTreeCompanion {
    ...
    fun <A, B : Any, C, D : Any> ofMap(items: Iterator<TKVEntry<A, B>>, allowDups: Boolean, f: (TKVEntry<A, B>) -> TKVEntry<C, D>): FBSTree<C, D> where A: Any, A: Comparable<A>, C: Any, C: Comparable<C>
    ...
    fun <A, B: Any> of(items: IMList<TKVEntry<A, B>>, allowDups: Boolean = false): FBSTree<A, B> where A: Any, A: Comparable<A>
    ...
    fun <B: Any, C: Any> ofviMap(items: IMList<B>, allowDups: Boolean, f: (B) -> C): IMBTree<Int, C>
    fun <B: Any, C: Any> ofvsMap(items: IMList<B>, allowDups: Boolean, f: (B) -> C): IMBTree<String, C>
    fun <B: Any, C: Any> ofviMap(items: List<B>, allowDups: Boolean, f: (B) -> C): IMBTree<Int, C>
    fun <B: Any, C: Any> ofvsMap(items: List<B>, allowDups: Boolean, f: (B) -> C): IMBTree<String, C>

    suspend fun <A, B: Any> find(treeStub: IMBTree<A, B>, isMatch: (TKVEntry<A,B>) -> Boolean): IMList<TKVEntry<A,B>> where A: Any, A: Comparable<A>
}