...
private val intListOfNone: IMListGrouping<Int> = FList.of(*arrayOf<Int>())
...
private val strListOfNone: IMListGrouping<String> = FList.of(*arrayOf<String>())
...
class FListGroupingTest : FunSpec({
  ...
  test("zipWith") {
    intListOfNone.fzipWith(FList.of(*arrayOf<String>())){a, b -> Pair(a,b)} shouldBe FLNil
    intListOfOne.fzipWith(FList.of(*arrayOf<String>())){a, b -> Pair(a,b)} shouldBe FLNil
    ...
    intListOfThree.fzipWith(FList.of(*arrayOf<String>())){a, b -> Pair(a,b)} shouldBe FLNil
  ...
  test("zipWith iterable") {
    intListOfNone.fzipWith(arrayOf<String>().iterator()) shouldBe FLNil
    intListOfOne.fzipWith(arrayOf<String>().iterator()) shouldBe FLNil
  ...
  test("fzipWithIndex offset") {
    FList.of(*arrayOf<String>()).fzipWithIndex(10) shouldBe FLNil
