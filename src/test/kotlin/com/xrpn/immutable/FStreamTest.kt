...
//  }
  ...
  test("findFirst") {
    ...
    listed(FStream.of(*arrayOf<Int>(3,2,1)).findFirst { it > 1 })  shouldBe listed(Triple(FSNil, 3, FStream.of(*arrayOf<Int>(2,1))))
    listed(FStream.of(*arrayOf<Int>(3,2,1,0)).findFirst { it == 2 }) shouldBe listed(Triple(fsCons(hdThree, tailInt), 2, FStream.of(*arrayOf<Int>(1,0))))
    listed(FStream.of(*arrayOf<Int>(3,2,1,0)).findFirst { it < 3 }) shouldBe listed(Triple(fsCons(hdThree, tailInt), 2, FStream.of(*arrayOf<Int>(1,0))))
  ...
  test("zipWith") {
    ...
    intStreamOfOne().zipWith_a(FStream.of(*arrayOf<String>("a","b"))){ a, b -> Pair(a,b)}.toFList() shouldBe FLCons(Pair(1,"a"),FLNil)
    intStreamOfTwo().zipWith_a(FStream.of(*arrayOf<String>("a","b"))){ a, b -> Pair(a,b)}.toFList() shouldBe FLCons(Pair(1,"a"),FLCons(Pair(2,"b"),FLNil))
    intStreamOfThree().zipWith_a(FStream.of(*arrayOf<String>("a","b"))){ a, b -> Pair(a,b)}.toFList() shouldBe FLCons(Pair(1,"a"),FLCons(Pair(2,"b"),FLNil))
    intStreamOfTwo().zipWith_a(FStream.of(*arrayOf<String>("a","b","c"))){ a, b -> Pair(a,b)}.toFList() shouldBe FLCons(Pair(1,"a"),FLCons(Pair(2,"b"),FLNil))
  }
