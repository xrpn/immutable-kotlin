...
class FListGroupingTest : FunSpec({
  ...
  test("fsplitAt") {
    // TODO OOM_ERR intListOfNone.fsplitAt((intListOfNone as FList<Int>).asList().indexOfFirst { it > 1 }) shouldBe Triple(FLNil, null, FLNil)
    // TODO OOM_ERR intListOfOne.fsplitAt((intListOfOne as FList<Int>).asList().indexOfFirst { it > 1 })  shouldBe Triple(FLCons(1,FLNil), null, FLNil)
