...
class FKSetNISKTest : FunSpec({
    ...
    test("K to FKSet") {
        copaKKSetOf3.toIMKSet(copaKey)?.equals(copaKKSetOf3) shouldBe true
        (copaKKSetOf3.toIMKSet(copaKey) === copaKKSetOf3) shouldBe true
        copaKKSetOf3.toIMKSet(IntKeyType)?.equals(copaISetOf3) shouldBe true
        copaKKSetOf3.toIMKSet(StrKeyType)?.equals(copaSSetOf3) shouldBe true
    }

    test("I to FKSet") {
        copaISetOf3.toIMKSet(copaKey)?.equals(copaKKSetOf3) shouldBe true
        copaISetOf3.toIMKSet(IntKeyType)?.equals(copaISetOf3) shouldBe true
        (copaISetOf3.toIMKSet(IntKeyType) === copaISetOf3) shouldBe true
        copaISetOf3.toIMKSet(StrKeyType)?.equals(copaSSetOf3) shouldBe true
    }

    test("S to FKSet") {
        copaSSetOf3.toIMKSet(copaKey)?.equals(copaKKSetOf3) shouldBe true
        copaSSetOf3.toIMKSet(IntKeyType)?.equals(copaISetOf3) shouldBe true
        copaSSetOf3.toIMKSet(StrKeyType)?.equals(copaSSetOf3) shouldBe true
        (copaSSetOf3.toIMKSet(StrKeyType) === copaSSetOf3) shouldBe true
    }
