...
private val strQueueOfNoneNR = FQueue.of(*emptyArrayOfStr)
...
class FQueueCompanionTest : FunSpec({
  ...
  test("co.of vararg (not ready)") {
    of(*emptyArrayOfInt) shouldBe emptyIMQueue()
  ...
  test("co.of vararg (ready)") {
    of(*emptyArrayOfInt, readyToDequeue = true) shouldBe emptyIMQueue()
