...
private val intListOfNone: List<Int> = FList.of(*emptyArrayOfInt).asList()
private val intListOfOneA: List<Int> = FList.of(*arrayOf<Int>(0)).asList()
private val intListOfOne: List<Int> = FList.of(*arrayOf<Int>(1)).asList()
private val intListOfOneB: List<Int> = FList.of(*arrayOf<Int>(2)).asList()
private val intListOfOneC: List<Int> = FList.of(*arrayOf<Int>(3)).asList()
private val intListOfOneD: List<Int> = FList.of(*arrayOf<Int>(4)).asList()
private val intListOfTwoA: List<Int> = FList.of(*arrayOf<Int>(1,3)).asList()
private val intListOfTwo: List<Int> = FList.of(*arrayOf<Int>(1,2)).asList()
private val intListOfTwoB: List<Int> = FList.of(*arrayOf<Int>(0,2)).asList()
private val intListOfTwoC: List<Int> = FList.of(*arrayOf<Int>(1,4)).asList()
private val intListOfThree: List<Int> = FList.of(*arrayOf<Int>(1,2,3)).asList()
private val intListOfThreeA: List<Int> = FList.of(*arrayOf<Int>(1,2,5)).asList()
private val intListOfFive: List<Int> = FList.of(*arrayOf<Int>(1,2,3,2,1)).asList()
private val intListOfSix: List<Int> = FList.of(*arrayOf<Int>(1,2,3,3,2,1)).asList()
...
class FListKListTest : FunSpec({
  ...
  test("subList") {
    intListOfSix.subList(0, 0) shouldBe intListOfNone
    intListOfSix.subList(0, 1) shouldBe intListOfOne
    intListOfSix.subList(0, 2) shouldBe intListOfTwo
    intListOfSix.subList(0, 3) shouldBe intListOfThree
    intListOfSix.subList(3, 6) shouldBe intListOfThree.reversed()
  }
  ...
  test("dropLast") {
    ...
    intListOfThree.dropLast(1)  shouldBe listOf(1, 2)
    intListOfThree.dropLast(2)  shouldBe listOf(1)
    intListOfThree.dropLast(3)  shouldBe intListOfNone
  }

  test("dropLastWhile") {
    intListOfSix.dropLastWhile { it < 3 } shouldBe listOf(1,2,3,3)
    intListOfSix.dropLastWhile { it < 4 } shouldBe intListOfNone
  }

  test("slice of range") {
    intListOfSix.slice(0 until 0) shouldBe intListOfNone
    intListOfSix.slice(0 until 1) shouldBe intListOfOne
    intListOfSix.slice(0..1) shouldBe intListOfTwo
    intListOfSix.slice(0 until 2) shouldBe intListOfTwo
    intListOfSix.slice(0..2) shouldBe intListOfThree
    intListOfSix.slice(0 until 3) shouldBe intListOfThree
    intListOfSix.slice(3 until 6) shouldBe intListOfThree.reversed()
    // noteworthy
    intListOfSix.slice(3..6) shouldBe intListOfThree.reversed()
    intListOfSix.slice(3..100) shouldBe intListOfThree.reversed()
  }
  ...
  test("takeLast") {
    ...
    intListOfThree.takeLast(1)  shouldBe listOf(3)
    intListOfThree.takeLast(2)  shouldBe listOf(2,3)
    intListOfThree.takeLast(3)  shouldBe intListOfThree
  }

  test("takeLastWhile") {
    intListOfSix.takeLastWhile { it < 3 } shouldBe listOf(2,1)
  ...
  test("foldRight diff") {
    ...
    FList.of(*arrayOf<Int>(2,1)).asList().foldRight(0, d)  shouldBe 1
    FList.of(*arrayOf<Int>(3,2,1)).asList().foldRight(0, d)  shouldBe 2
    FList.of(*arrayOf<Int>(3,2,1,0)).asList().foldRight(0, d) shouldBe 2
  }
  ...
  test("foldRight sum") {
    ...
    FList.of(*arrayOf<Int>(2,1)).asList().foldRight(0, s)  shouldBe 3
    FList.of(*arrayOf<Int>(3,2,1)).asList().foldRight(0, s)  shouldBe 6
    FList.of(*arrayOf<Int>(3,2,1,0)).asList().foldRight(0, s) shouldBe 6
  }
  ...
  test("foldRight product") {
    ...
    FList.of(*arrayOf<Int>(2,1)).asList().foldRight(1, ss) shouldBe 2
    FList.of(*arrayOf<Int>(3,2,1)).asList().foldRight(1, ss) shouldBe 6
    FList.of(*arrayOf<Int>(3,2,1,0)).asList().foldRight(1, ss) shouldBe 0
  }
