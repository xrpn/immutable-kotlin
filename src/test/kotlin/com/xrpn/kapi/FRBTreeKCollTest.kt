...
private val intFrbtOfNone: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*emptyArrayOfInt).asCollection()
private val intFrbtOfOneA: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(0)).asCollection()
private val intFrbtOfOne: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1)).asCollection()
private val intFrbtOfOneB: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(2)).asCollection()
private val intFrbtOfOneC: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(3)).asCollection()
private val intFrbtOfOneD: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(4)).asCollection()
private val intFrbtOfTwoA: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,3)).asCollection()
private val intFrbtOfTwo: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,2)).asCollection()
private val intFrbtOfTwoB: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(0,2)).asCollection()
private val intFrbtOfTwoC: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,4)).asCollection()
private val intFrbtOfThree: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,2,3)).asCollection()
private val intFrbtOfThreeA: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,2,5)).asCollection()
private val intFrbtOfFive: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,2,3,4,5)).asCollection()
private val intFrbtOfFiveA: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,2,3,2,1)).asCollection()
private val intFrbtOfSix: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(*arrayOf<Int>(1,2,3,3,2,1)).asCollection()
private val intFrbtOf2: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(2).asCollection()
private val intFrbtOf3: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(3).asCollection()
private val intFrbtOf4: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(4).asCollection()
private val intFrbtOf5: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(5).asCollection()
private val intFrbtOf13: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(1, 3).asCollection()
private val intFrbtOf23: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(2, 3).asCollection()
private val intFrbtOf25: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(2, 5).asCollection()
private val intFrbtOf45: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(4, 5).asCollection()
private val intFrbtOf125: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(1, 2, 5).asCollection()
private val intFrbtOf145: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(1, 4, 5).asCollection()
private val intFrbtOf245: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(2, 4, 5).asCollection()
private val intFrbtOf1245: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(1, 2, 4, 5).asCollection()
private val intFrbtOf1235: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(1, 2, 3, 5).asCollection()
private val intFrbtOf1345: Collection<TKVEntry<Int, Int>> = FRBTree.ofvi(1, 3, 4, 5).asCollection()
...
class FRBTreeKCollTest : FunSpec({
  ...
  test("FTree equals") {
    ...
    (intFrbtOfNone == FKSet.emptyIMKISet<Int>()) shouldBe false
    ...
    (intFrbtOfOne == FKSet.emptyIMKISet<Int>()) shouldBe false
  ...
  test("FTree equals miss") {
    ...
    intFrbtOfTwo.equals(FKSet.ofi(1)) shouldBe false
    (intFrbtOfTwo == FKSet.ofi(2)) shouldBe false
    (intFrbtOfTwo == FKSet.ofi(2, 1)) shouldBe false
    (intFrbtOfTwo == FKSet.ofi(1, 2)) shouldBe false
    ...
    (intFrbtOfThree == FKSet.ofi(1, 2, 3)) shouldBe false
    (intFrbtOfThree == FKSet.ofi(1, 3, 2)) shouldBe false
    (intFrbtOfThree == FKSet.ofi(2, 1, 3)) shouldBe false
    (intFrbtOfThree == FKSet.ofi(3, 2, 1)) shouldBe false
  }
  ...
  test("iteration order") {
    intFrbtOfThree shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry())
    intFrbtOfFive shouldBe listOf(1.toIAEntry(),2.toIAEntry(),3.toIAEntry(),4.toIAEntry(),5.toIAEntry())
  }
  ...
  test("drop 2") {
    ...
    val aux2 = a2.asCollection().drop(2).toSet()
    (aux2.size == a2.size - 2) shouldBe true
    a2.asCollection().containsAll(aux2) shouldBe true
  }
  ...
  test("drop 3") {
    ...
    val a2 = FRBTree.ofvi(*arrayOf<Int>(1,2,3,4))
    val aux2 = a2.asCollection().drop(3).toSet()
  ...
  test("filter") {
    ...
    intFrbtOfTwo.filter {0 == it.getv() % 2} shouldBe listOf(2.toIAEntry())
    intFrbtOfThree.filter {0 == it.getv() % 2} shouldBe listOf(2.toIAEntry())
    FRBTree.ofvi(*arrayOf<Int>(1,2,3,4)).asCollection().filter {0 == it.getv() % 2} shouldBe listOf(2.toIAEntry(), 4.toIAEntry())
  }
  ...
  test("filterNot") {
    ...
    intFrbtOfOne.filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry())
    intFrbtOfTwo.filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry())
    intFrbtOfThree.filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry(),3.toIAEntry())
    FRBTree.ofvi(*arrayOf<Int>(1,2,3,4)).asCollection().filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry(), 3.toIAEntry())
  }
  ...
  test("take 2") {
    ...
    val aux3 = a3.asCollection().take(2)
    aux3.size shouldBe 2
    a3.asCollection().containsAll(aux3) shouldBe true
  }
  ...
  test("take 3") {
    ...
    val a3 = FRBTree.ofvi(*arrayOf<Int>(1,2,3,4))
    val aux3 = a3.asCollection().take(3)
  ...
  test("reversed") {
    ...
    intFrbtOfOne.reversed() shouldBe  listOf(1.toIAEntry())
    intFrbtOfTwo.reversed() shouldBe listOf(2.toIAEntry(), 1.toIAEntry())
    intFrbtOfThree.reversed() shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
  }
  ...
  test("sortedDescending") {
    ...
    intFrbtOfOne.sortedDescending() shouldBe listOf(1.toIAEntry())
    intFrbtOfTwo.sortedDescending() shouldBe listOf(2.toIAEntry(), 1.toIAEntry())
    intFrbtOfThree.sortedDescending() shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
    intFrbtOfSix.sortedDescending() shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
  }

  test("sortedBy") {

    intFrbtOfNone.sortedBy(::reverseNumerical) shouldBe emptyList()
    intFrbtOfOne.sortedBy(::reverseNumerical) shouldBe listOf(1.toIAEntry())
    intFrbtOfTwo.sortedBy(::reverseNumerical) shouldBe listOf(2.toIAEntry(), 1.toIAEntry())
    intFrbtOfThree.sortedBy(::reverseNumerical) shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
    intFrbtOfSix.sortedBy(::reverseNumerical) shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
  }
  ...
  test("sortedWith") {
    ...
    intFrbtOfOne.sortedWith(reverseNumerical) shouldBe listOf(1.toIAEntry())
    intFrbtOfTwo.sortedWith(reverseNumerical) shouldBe listOf(2.toIAEntry(), 1.toIAEntry())
    intFrbtOfThree.sortedWith(reverseNumerical) shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
    intFrbtOfSix.sortedWith(reverseNumerical) shouldBe listOf(3.toIAEntry(), 2.toIAEntry(), 1.toIAEntry())
  }
  ...
  test("flatMap") {
    intFrbtOfNone.flatMap{ FRBTree.ofvi(it).asCollection() } shouldBe emptyList()
    intFrbtOfOne.flatMap{ FRBTree.ofvi(it).asCollection() } shouldBe listOf(1.toIAEntry().toIAEntry())
    fun arrayBuilderConst(arg: Int) = Array(arg) { _ -> arg }
    intFrbtOfTwo.flatMap {FRBTree.ofvi(*arrayBuilderConst(it.getv())).asCollection()} shouldBe listOf(1.toIAEntry(), 2.toIAEntry())
    fun arrayBuilderIncrement(arg: Int) = Array(arg) { i -> (arg + i) }
    intFrbtOfTwo.flatMap {FRBTree.ofvi(*arrayBuilderIncrement(it.getv())).asCollection()} shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry())
    intFrbtOfThree.flatMap {FRBTree.ofvi(*arrayBuilderIncrement(it.getv())).asCollection()} shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry(), 3.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())
    intFrbtOfThree.flatMap { i -> FRBTree.ofvi(i, i).asCollection() } shouldBe FRBTree.ofvi(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry()).asCollection()
  }
  ...
  test("map") {
    ...
    intFrbtOfOne.map { it.getv() + 1} shouldBe listOf(2)
    intFrbtOfTwo.map { it.getv() + 1} shouldBe listOf(2, 3)
  }
  ...
  test("union") {
    ...
    intFrbtOf13.union(intFrbtOfTwo).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry())
    intFrbtOf13.union(intFrbtOfThree).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry())
    intFrbtOf13.union(intFrbtOf25).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry(), 5.toIAEntry())
    intFrbtOf13.union(intFrbtOf45) shouldBe intFrbtOf1345

    intFrbtOf25.union(intFrbtOfOne).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 5.toIAEntry())
    intFrbtOf25.union(intFrbtOfTwo).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 5.toIAEntry())
    intFrbtOf25.union(intFrbtOfThree).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry(), 5.toIAEntry())
    intFrbtOf25.union(intFrbtOf13).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry(), 5.toIAEntry())
    intFrbtOf25.union(intFrbtOf45).sorted() shouldBe listOf(2.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())

    intFrbtOf45.union(intFrbtOfOne).sorted() shouldBe listOf(1.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())
    intFrbtOf45.union(intFrbtOfTwo).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())
    intFrbtOf45.union(intFrbtOfThree).sorted() shouldBe listOf(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())
    intFrbtOf45.union(intFrbtOf13).sorted() shouldBe listOf(1.toIAEntry(), 3.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())
    intFrbtOf45.union(intFrbtOf25).sorted() shouldBe listOf(2.toIAEntry(), 4.toIAEntry(), 5.toIAEntry())
  ...
  test("partition") {
    intFrbtOfOne.partition(matchLessThan(1)) shouldBe Pair(emptyList(), listOf(1.toIAEntry()))
    intFrbtOfThree.partition(matchLessThan(2)) shouldBe Pair(listOf(1.toIAEntry()), listOf(2.toIAEntry(), 3.toIAEntry()))
  }
