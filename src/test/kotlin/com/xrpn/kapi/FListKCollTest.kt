...
private val intListOfNone: Collection<Int> = FList.of(*emptyArrayOfInt).asList()
private val intListOfOneA: Collection<Int> = FList.of(*arrayOf<Int>(0)).asList()
private val intListOfOne: Collection<Int> = FList.of(*arrayOf<Int>(1)).asList()
private val intListOfOneB: Collection<Int> = FList.of(*arrayOf<Int>(2)).asList()
private val intListOfOneC: Collection<Int> = FList.of(*arrayOf<Int>(3)).asList()
private val intListOfOneD: Collection<Int> = FList.of(*arrayOf<Int>(4)).asList()
private val intListOfTwoA: Collection<Int> = FList.of(*arrayOf<Int>(1,3)).asList()
private val intListOfTwo: Collection<Int> = FList.of(*arrayOf<Int>(1,2)).asList()
private val intListOfTwoB: Collection<Int> = FList.of(*arrayOf<Int>(0,2)).asList()
private val intListOfTwoC: Collection<Int> = FList.of(*arrayOf<Int>(1,4)).asList()
private val intListOfThree: Collection<Int> = FList.of(*arrayOf<Int>(1,2,3)).asList()
private val intListOfThreeA: Collection<Int> = FList.of(*arrayOf<Int>(1,2,5)).asList()
private val intListOfFive: Collection<Int> = FList.of(*arrayOf<Int>(1,2,3,2,1)).asList()
private val intListOfSix: Collection<Int> = FList.of(*arrayOf<Int>(1,2,3,3,2,1)).asList()
...
class FListKCollTest : FunSpec({
  ...
  test("drop 2") {
    ...
    FList.of(*arrayOf<Int>(1,2,3,4)).asList().drop(2).toIMList() shouldBe FLCons(3,FLCons(4,FLNil))
  }
  ...
  test("drop 3") {
    ...
    FList.of(*arrayOf<Int>(1,2,3,4)).asList().drop(3).toIMList() shouldBe FLCons(4,FLNil)
  }

  test("dropWhile") {
    intListOfNone.dropWhile { it > 1 }.toIMList() shouldBe FLNil
    intListOfOne.dropWhile { it > 1 }.toIMList()  shouldBe FLCons(1,FLNil)
    FList.of(*arrayOf<Int>(2,1)).asList().dropWhile { it > 1 }.toIMList()  shouldBe FLCons(1,FLNil)
    FList.of(*arrayOf<Int>(3,2,1)).asList().dropWhile { it > 1 }.toIMList()  shouldBe FLCons(1,FLNil)
    val a1 = FList.of(*arrayOf<Int>(3,2,1,0,3)).asList()
  ...
  test("filter") {
    ...
    FList.of(*arrayOf<Int>(1,2,3,4)).asList().filter {0 == it % 2}.toIMList() shouldBe FLCons(2,FLCons(4,FLNil))
  }
  ...
  test("filterNot") {
    ...
    FList.of(*arrayOf<Int>(1,2,3,4)).asList().filterNot {0 == it % 2}.toIMList() shouldBe FLCons(1,FLCons(3,FLNil))
  }
  ...
  test("take 2") {
    ...
    FList.of(*arrayOf<Int>(1,2,3,4)).asList().take(2) shouldBe intListOfTwo
  }
  ...
  test("take 3") {
    ...
    FList.of(*arrayOf<Int>(1,2,3,4)).asList().take(3).toIMList() shouldBe intListOfThree
  }

  test("takeWhile") {
    intListOfNone.takeWhile { it > 1 }.toIMList() shouldBe FLNil
    intListOfOne.takeWhile { it == 1 }.toIMList()  shouldBe FLCons(1,FLNil)
    FList.of(*arrayOf<Int>(2,1)).asList().takeWhile { it > 1 }.toIMList()  shouldBe FLCons(2,FLNil)
    FList.of(*arrayOf<Int>(3,2,1)).asList().takeWhile { it > 1 }.toIMList()  shouldBe FLCons(3,FLCons(2,FLNil))
    FList.of(*arrayOf<Int>(3,2,1,0)).asList().takeWhile { it != 1 }.toIMList() shouldBe FLCons(3,FLCons(2,FLNil))
  }

  test("reversed") {
    intListOfNone.reversed().toIMList() shouldBe FLNil
    intListOfOne.reversed().toIMList().equals((intListOfOne.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfTwo.reversed().toIMList().equals((intListOfTwo.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfThree.reversed().toIMList().equals((intListOfThree.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
  }
  ...
  test("sortedDescending") {
    ...
    intListOfOne.sortedDescending().toIMList().equals((intListOfOne.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfTwo.sortedDescending().toIMList().equals((intListOfTwo.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfThree.sortedDescending().toIMList().equals((intListOfThree.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfSix.sortedDescending().toIMList().equals(FLCons(3, FLCons(3, FLCons(2, FLCons(2, FLCons(1, FLCons(1, FLNil))))))) shouldBe true
  }
  ...
  test("sortedBy") {
    ...
    intListOfOne.sortedBy(::reverseNumerical).toIMList().equals((intListOfOne.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfTwo.sortedBy(::reverseNumerical).toIMList().equals((intListOfTwo.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfThree.sortedBy(::reverseNumerical).toIMList().equals((intListOfThree.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfSix.sortedBy(::reverseNumerical).toIMList().equals(
            FLCons(3, FLCons(3, FLCons(2, FLCons(2, FLCons(1, FLCons(1, FLNil))))))) shouldBe true
  }
  ...
  test("sortedWith") {
    ...
    intListOfOne.sortedWith(reverseNumerical).toIMList().equals((intListOfOne.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfTwo.sortedWith(reverseNumerical).toIMList().equals((intListOfTwo.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfThree.sortedWith(reverseNumerical).toIMList().equals((intListOfThree.iterator() as FListIteratorFwd<Int>).retriever.original().freverse()) shouldBe true
    intListOfSix.sortedWith(reverseNumerical).toIMList().equals(
            FLCons(3, FLCons(3, FLCons(2, FLCons(2, FLCons(1, FLCons(1, FLNil))))))) shouldBe true
  }
  ...
  test("flatMap") {
    intListOfNone.flatMap {it -> FLCons(it, FLNil).asList()}.toIMList() shouldBe FLNil
    intListOfOne.flatMap {it -> FLCons(it, FLNil).asList()}.toIMList() shouldBe FLCons(1,FLNil)
    fun arrayBuilderConst(arg: Int) = Array<Int>(arg) { _ -> arg }
    intListOfTwo.flatMap {FList.of(*arrayBuilderConst(it)).asList()}.toIMList() shouldBe FLCons(1,FLCons(2,FLCons(2,FLNil)))
    fun arrayBuilderIncrement(arg: Int) = Array<Int>(arg) { i -> arg + i }
    intListOfTwo.flatMap {FList.of(*arrayBuilderIncrement(it)).asList()}.toIMList() shouldBe FLCons(1,FLCons(2,FLCons(3,FLNil)))
    intListOfThree.flatMap {FList.of(*arrayBuilderIncrement(it)).asList()}.toIMList() shouldBe
        FLCons(1,FLCons(2,FLCons(3,FLCons(3,FLCons(4,FLCons(5,FLNil))))))
    intListOfThree.flatMap { i -> FList.of(i, i).asList() }.toIMList() shouldBe
        FLCons(1,FLCons(1,FLCons(2,FLCons(2,FLCons(3,FLCons(3,FLNil))))))
  }
  ...
  test("windowed") {
    intListOfThree.windowed(2) shouldBe listOf(intListOfTwo,listOf(2,3))
  }
