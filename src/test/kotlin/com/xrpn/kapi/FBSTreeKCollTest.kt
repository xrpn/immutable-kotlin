...
private val intFbstOfNone: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*emptyArrayOfInt).asCollection()
private val intFbstOfOneA: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(0)).asCollection()
private val intFbstOfOneT = FBSTree.ofvi(*arrayOf<Int>(1))
private val intFbstOfOne: Collection<TKVEntry<Int, Int>> = intFbstOfOneT.asCollection()
private val intFbstOfOneB: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(2)).asCollection()
private val intFbstOfOneC: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(3)).asCollection()
private val intFbstOfOneD: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(4)).asCollection()
private val intFbstOfTwoA: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(1,3)).asCollection()
private val intFbstOfTwoT = FBSTree.ofvi(*arrayOf<Int>(1,2))
private val intFbstOfTwo: Collection<TKVEntry<Int, Int>> = intFbstOfTwoT.asCollection()
private val intFbstOfTwoB: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(0,2)).asCollection()
private val intFbstOfTwoC: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(1,4)).asCollection()
private val intFbstOfThreeT = FBSTree.ofvi(*arrayOf<Int>(1,2,3))
private val intFbstOfThree: Collection<TKVEntry<Int, Int>> = intFbstOfThreeT.asCollection()
private val intFbstOfThreeA: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(1,2,5)).asCollection()
private val intFbstOfFiveT = FBSTree.ofvi(*arrayOf<Int>(1,2,3,4,5))
private val intFbstOfFive: Collection<TKVEntry<Int, Int>> = intFbstOfFiveT.asCollection()
private val intFbstOfFiveA: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(1,2,3,2,1)).asCollection()
private val intFbstOfSix: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(*arrayOf<Int>(1,2,3,3,2,1)).asCollection()
private val intFbstOf2: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(2).asCollection()
private val intFbstOf3: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(3).asCollection()
private val intFbstOf4: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(4).asCollection()
private val intFbstOf5: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(5).asCollection()
private val intFbstOf13: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(1, 3).asCollection()
private val intFbstOf23: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(2, 3).asCollection()
private val intFbstOf25: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(2, 5).asCollection()
private val intFbstOf45: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(4, 5).asCollection()
private val intFbstOf125: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(1, 2, 5).asCollection()
private val intFbstOf145: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(1, 4, 5).asCollection()
private val intFbstOf245: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(2, 4, 5).asCollection()
private val intFbstOf1245: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(1, 2, 4, 5).asCollection()
private val intFbstOf1235: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(1, 2, 3, 5).asCollection()
private val intFbstOf1345: Collection<TKVEntry<Int, Int>> = FBSTree.ofvi(1, 3, 4, 5).asCollection()
...
class FBSTreeKCollTest : FunSpec({
  ...
  test("Collections equals") {
    ...
    (setOf(1.toIAEntry()) == intFbstOfOne) shouldBe false
    (FKSet.ofi(1) == intFbstOfOne) shouldBe false
  ...
  test("iteration order") {
    intFbstOfThree shouldBe intFbstOfThreeT.inorder().copyToMutableList()
    intFbstOfFive shouldBe intFbstOfFiveT.inorder().copyToMutableList()
  }
  ...
  test("drop 2") {
    ...
    val a2 = FBSTree.ofvi(*arrayOf<Int>(1,2,3,4)).asCollection()
  ...
  test("filter") {
    ...
    intFbstOfTwo.filter {0 == it.getv() % 2} shouldBe listOf(2.toIAEntry())
    intFbstOfThree.filter {0 == it.getv() % 2} shouldBe listOf(2.toIAEntry())
    FBSTree.ofvi(*arrayOf<Int>(1,2,3,4)).asCollection().filter {0 == it.getv() % 2} shouldBe listOf(2.toIAEntry(), 4.toIAEntry())
  }
  ...
  test("filterNot") {
    ...
    intFbstOfOne.filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry())
    intFbstOfTwo.filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry())
    intFbstOfThree.filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry(),3.toIAEntry())
    FBSTree.ofvi(*arrayOf<Int>(1,2,3,4)).asCollection().filterNot {0 == it.getv() % 2} shouldBe listOf(1.toIAEntry(), 3.toIAEntry())
  }
  ...
  test("reversed") {
    ...
    intFbstOfOne.reversed() shouldBe listOf(1.toIAEntry())
    intFbstOfTwo.reversed() shouldBe listOf(2.toIAEntry(),1.toIAEntry())
    intFbstOfThree.reversed() shouldBe listOf(3.toIAEntry(),2.toIAEntry(),1.toIAEntry())
  }
  ...
  test("sortedDescending") {
    ...
    intFbstOfTwo.sortedDescending().toSet() shouldBe listOf(2.toIAEntry(),1.toIAEntry())
    intFbstOfThree.sortedDescending().toSet() shouldBe listOf(3.toIAEntry(),2.toIAEntry(),1.toIAEntry())
  ...
  test("sortedBy") {
    ...
    intFbstOfTwo.sortedBy(::reverseNumerical) shouldBe listOf(2.toIAEntry(),1.toIAEntry())
    intFbstOfThree.sortedBy(::reverseNumerical) shouldBe listOf(3.toIAEntry(),2.toIAEntry(),1.toIAEntry())
    intFbstOfSix.sortedBy(::reverseNumerical) shouldBe listOf(3.toIAEntry(),2.toIAEntry(),1.toIAEntry())
  }
  ...
  test("sortedWith") {
    ...
    intFbstOfTwo.sortedWith(reverseNumerical) shouldBe listOf(2.toIAEntry(),1.toIAEntry())
    intFbstOfThree.sortedWith(reverseNumerical) shouldBe listOf(3.toIAEntry(),2.toIAEntry(),1.toIAEntry())
    intFbstOfSix.sortedWith(reverseNumerical) shouldBe listOf(3.toIAEntry(),2.toIAEntry(),1.toIAEntry())
  }
  ...
  test("flatMap") {
    intFbstOfNone.flatMap{ FBSTree.ofvi(it).asCollection() } shouldBe emptyList()
    intFbstOfOne.flatMap{ FBSTree.ofvi(it).asCollection() } shouldBe FBSTree.ofvi(1.toIAEntry()).asCollection()
    fun arrayBuilderConst(arg: Int) = Array(arg) { _ -> arg }
    intFbstOfTwo.flatMap {FBSTree.ofvi(*arrayBuilderConst(it.getv())).asCollection()} shouldBe FBSTree.ofvi(1, 2).asCollection()
    fun arrayBuilderIncrement(arg: Int) = Array(arg) { i -> (arg + i) }
    intFbstOfTwo.flatMap {FBSTree.ofvi(*arrayBuilderIncrement(it.getv())).asCollection()} shouldBe FBSTree.ofvi(1, 2, 3).asCollection()
    intFbstOfThree.flatMap {FBSTree.ofvi(*arrayBuilderIncrement(it.getv())).asCollection()} shouldBe FList.of(1, 2, 3, 3, 4, 5).toIAEntries().copyToMutableList()
    intFbstOfThree.flatMap { i -> FBSTree.ofvi(i, i).asCollection() } shouldBe FBSTree.ofvi(1.toIAEntry(), 2.toIAEntry(), 3.toIAEntry(),).asCollection()
  }
  ...
  test("map") {
    ...
    intFbstOfOne.map { it.getv() + 1} shouldBe listOf(2)
    intFbstOfTwo.map { it.getv() + 1} shouldBe listOf(2,3)
  }
  ...
  test("partition") {
    intFbstOfOne.partition(matchLessThan(1)) shouldBe Pair(emptyList(), listOf(1.toIAEntry()))
    intFbstOfThree.partition(matchLessThan(2)) shouldBe Pair(listOf(1.toIAEntry()), listOf(2.toIAEntry(), 3.toIAEntry()))
  }
